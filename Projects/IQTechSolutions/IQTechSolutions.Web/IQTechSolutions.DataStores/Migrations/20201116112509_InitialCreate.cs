        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ImageFileCategoryBlogPost_EntityId = table.Column<string>(name: "ImageFile<Category<BlogPost>>_EntityId", type: "nvarchar(450)", nullable: true),
                    ImageFileDepartmentBlogPost_EntityId = table.Column<string>(name: "ImageFile<Department<BlogPost>>_EntityId", type: "nvarchar(450)", nullable: true),
                    DisplayIndex = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageFile_BlogPost_EntityId",
                        column: x => x.EntityId,
                        principalTable: "BlogPost",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImageFile_Category<BlogPost>_ImageFile<Category<BlogPost>>_EntityId",
                        column: x => x.ImageFileCategoryBlogPost_EntityId,
                        principalTable: "Category<BlogPost>",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImageFile_Department<BlogPost>_ImageFile<Department<BlogPost>>_EntityId",
                        column: x => x.ImageFileDepartmentBlogPost_EntityId,
                        principalTable: "Department<BlogPost>",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageFile_EntityId",
                table: "ImageFile",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageFile_ImageFile<Category<BlogPost>>_EntityId",
                table: "ImageFile",
                column: "ImageFile<Category<BlogPost>>_EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageFile_ImageFile<Department<BlogPost>>_EntityId",
                table: "ImageFile",
                column: "ImageFile<Department<BlogPost>>_EntityId");
