...
{
    [ViewComponent]
    public class PopularPostsSidebarWidget : ViewComponent
    {
        private readonly HttpClient _client;
        private readonly IApplicationConfiguration _applicationConfiguration;

        public PopularPostsSidebarWidget(IHttpClientFactory clientFactory, IApplicationConfiguration applicationConfiguration)
        {
