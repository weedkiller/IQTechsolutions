...
namespace Metsi.Web.Datastore.Migrations
{
    ...
    partial class MetsiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Education.Base.Entities.Module", b =>
                {
                    ...
                    b.Property<string>("StudentCourseCourseId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Education.Base.Entities.MultipleChoiceAnswer<Education.Base.Entities.Course>", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                    ...
                    b.Property<string>("AssessmentElementId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("MultipleChoiceAnswer<Course>");
                });

            modelBuilder.Entity("Education.Base.Entities.MultipleChoiceAnswer<Education.Base.Entities.Module>", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                    ...
                    b.ToTable("MultipleChoiceAnswer<Module>");
                });
            ...
            modelBuilder.Entity("Education.Base.Entities.Module", b =>
                {
                    ...
                    b.HasOne("Education.Base.Entities.StudentCourse", null)
            ...
            modelBuilder.Entity("Education.Base.Entities.MultipleChoiceAnswer<Education.Base.Entities.Course>", b =>
                {
                    b.HasOne("Education.Base.Entities.AssessmentElement<Education.Base.Entities.Course>", "AssessmentElement")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Education.Base.Entities.MultipleChoiceAnswer<Education.Base.Entities.Module>", b =>
                {
                    b.HasOne("Education.Base.Entities.AssessmentElement<Education.Base.Entities.Module>", "AssessmentElement")
                        .WithMany("Answers")
                        .HasForeignKey("AssessmentElementId");
            ...
            modelBuilder.Entity("Identity.Base.Entities.UserInfo", b =>
                {
                    ...
                    b.HasOne("Education.Base.Entities.Student", null)
                        .WithOne("UserInfo")
                        .HasForeignKey("Identity.Base.Entities.UserInfo", "StudentId");
                });
