...
*/var handleDatepicker = function () {
    ...
    handleIonRangeSlider = function () {
        $("#default_rangeSlider").ionRangeSlider({
            ...
            type: "double",
            prefix: "$",
            maxPostfix: "+", prettify: !1, hasGrid: !0
    ...
    handleFormColorPicker = function () {
        "use strict"; $("#colorpicker").colorpicker({ format: "hex" }),
    ...
    handleJqueryAutocomplete = function () {
        var a = ["ActionScript", "AppleScript", "Asp", "BASIC", "C", "C++", "Clojure", "COBOL", "ColdFusion", "Erlang", "Fortran", "Groovy", "Haskell", "Java", "JavaScript", "Lisp", "Perl", "PHP", "Python", "Ruby", "Scala", "Scheme"]; $("#jquery-autocomplete").autocomplete({ source: a })
    },
    ...
    handleDateRangePicker = function () {
        $("#default-daterange").daterangepicker({
            opens: "right", format: "MM/DD/YYYY", separator: " to ", startDate: moment().subtract("days", 29),
