...
var handleVectorMap = function () {
    "use strict"; if ($("#world-map").length !== 0) {
        $("#world-map").vectorMap({
            ...
            markerStyle: {
                ...
                initial: {
                    fill: "rgb(97,109,125)", "fill-opacity": 1,
    ...
    if (
        ...
        var r = [[1, ""], [2, ""], [3, "May&nbsp;15"], [4, ""], [5, ""], [6, "May&nbsp;19"], [7, ""], [8, ""], [9, "May&nbsp;22"], [10, ""], [11, ""], [12, "May&nbsp;25"], [13, ""], [14, ""], [15, "May&nbsp;28"], [16, ""], [17, ""], [18, "May&nbsp;31"], [19, ""], [20, ""]]; $.plot($("#interactive-chart"), [{
            data: t,
            label: "Page Views",
            color: blue,
            lines: {
    ...
    $(window).on("resize", function () {
        ...
        $("#sparkline-return-visitors").empty(); t()
    })
