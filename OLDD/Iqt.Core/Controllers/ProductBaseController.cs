...
using Iqt.Inventory.Models;
using Iqt.Inventory.Services;
using IQTechFramework.Models.Products;
...
namespace Iqt.Core.Controllers
{
    ...
    public class ProductBaseController : Controller
    {
        ...
        /// </summary>
        protected readonly ProductContextService Service;

        protected readonly CategoryContext<Product> CategoryService;

        /// <summary>
        /// The user manager for this Applciation
        /// </summary>
        protected readonly UserManager<ApplicationUser> UserManager;

        /// <summary>
        /// The sign-in manager for this Applciation
        /// </summary>
        ...
        public ProductBaseController(ProductContextService service, CategoryContext<Product> categoryService, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager)
        {
            Service = service;
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Brands = new SelectList(Service.GetAllBrands())
            };
