...
namespace Blogging.Base.Entities
{
    ...
    /// </summary>
    public class CaseStudy : ImageFileCollection<CaseStudy>
    {
        #region Properties
        ...
        /// </summary>
        [Display(Name = @"Title"), Required(ErrorMessage = @"Case Study needs a title")]
        ...
        /// The audio file
        /// </summary>
        public AudioFile<CaseStudy> AudioFile { get; set; }
        ...
        /// </summary>
        public ICollection<EntityCategory<CaseStudy>> Categories { get; set; } = new List<EntityCategory<CaseStudy>>();
