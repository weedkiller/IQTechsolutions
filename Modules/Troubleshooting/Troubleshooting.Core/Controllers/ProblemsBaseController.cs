...
namespace Troubleshooting.Core.Controllers
{
    ...
    public class ProblemsBaseController : Controller
    {
        ...
        /// </summary>
        /// <returns>The list view and model</returns>
        public async Task<IActionResult> ListUncategorized(string searchText)
        {
            var problems = await _service.GetAll().Where(c => !c.Categories.Any()).ToListAsync();
        ...
        public async Task<IActionResult> Create(string categoryId, string returnUrl)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var model = new ProblemAddEditModel(problem, _categoryService.GetAllCategories());
